...
/* harmony import */ var angular_file_uploader__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! angular-file-uploader */ "./node_modules/angular-file-uploader/fesm2015/angular-file-uploader.js");
...
/* harmony import */ var angular_highcharts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! angular-highcharts */ "./node_modules/angular-highcharts/fesm2015/angular-highcharts.js");
...
let FileVisualizerComponent = class FileVisualizerComponent {
    constructor(service) {
    ...
    selectFile(fileName) {
        ...
        this.loading = true;
        this.service.getFileData(fileName).subscribe((response) => {
...
FileVisualizerComponent.ctorParameters = () => [
...
let ThermometerService = class ThermometerService {
    constructor(http) {
        this.http = http;
    }
    getFiles() {
...
ThermometerService.ctorParameters = () => [
